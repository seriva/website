...
class TestRunner {
	...
	async testUtilities() {
		...
		if (typeof setDocumentTitle === "function") {
			...
			this.addResult(
				"setDocumentTitle",
				false,
				"setDocumentTitle function not found",
			);
		}
	}
	...
	async testRouting() {
		...
		this.addResult(
			"DOMCache exists",
			typeof DOMCache === "object",
			"DOMCache should exist",
		);
	}
